    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (!query.isEmpty()) {
                    filter_inventory(query, adapter_inventory, inentoryDatabase, mInventory);
                }else {
                    all_inventory(query, adapter_inventory, inentoryDatabase, mInventory);
                }
                return true;
            }
            ...
            public boolean onQueryTextChange(String newText) {
                if (!newText.isEmpty()) {
                    filter_inventory(newText, adapter_inventory, inentoryDatabase, mInventory);
                } else {
                    all_inventory(newText, adapter_inventory, inentoryDatabase, mInventory);
                }
                return false;
            }
        });
